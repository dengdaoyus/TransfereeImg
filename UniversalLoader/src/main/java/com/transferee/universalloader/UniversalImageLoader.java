package com.transferee.universalloader;
...
/**
 * Android-Universal-Image-Loader作为 Transferee 的图片加载器
 */
public class UniversalImageLoader  implements com.transferee.transferee.loader.ImageLoader  {
